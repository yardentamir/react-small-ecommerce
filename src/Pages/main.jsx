      ...
      <div className="container ui">
        <BrowserRouter>
          ...
          <Routes>
            ...
            <Route path="/products" exact element={<ProductList callBack={this.countProducts} counter={this.state.counter} />} />
            <Route path="/payment" exact element={<ProductPayment cartData={this.state.arrUserCart} />} />
          </Routes>
        </BrowserRouter>
      </div>
    )
